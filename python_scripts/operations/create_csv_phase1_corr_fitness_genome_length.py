...
from data_dict_phase1_corr_fitness_genome_length import create_data_dict as create_data_dict
from sort_csv_phase1_corr_fitness_genome_length import sort_csv as sort_csv
...
def create_csv(
    data_dict = (
        create_data_dict(
            log_name='data_dict_phase1_corr_fitness_genome_length_log.txt'
            )
        ), 
    ...
    with open(file_location, 'w+', newline='') as csvfile:
        ...
        csv_writer.writerow([
            ...
            'fitness_ancestor_value_log10',
            'genome_length_ancestor_value', 
            'genome_length_ancestor_value_log10',
