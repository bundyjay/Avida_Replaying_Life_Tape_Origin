...
group_means = (phase1_dataframe 
        ...
        >> summarize(
        group_mean = X.evolved_population_average_value.mean(),
        group_std = X.evolved_population_average_value.std()) 
...
def create_phase1_plot():
        ...
        trait_names = ["genome_length", "genome_length"] 
        value = [80, 120]
        ...
        genome_length_ancestor_value =  (
                phase1_dataframe_combined.query(
                        ...
                        .mean())
        trait_names = ["genome_length"] 
        value = list([genome_length_ancestor_value])
        ancestor_values = {'trait': trait_names, 'ancestor_value': value}  
        ancestor_data = DataFrame(ancestor_values) 
        ...
        >> group_by(X.time)
        >> summarize(grand_mean = X.evolved_population_average_value.mean())
        )
        ...
        std_plot = (
                ...
                + scale_y_continuous(name='Variation in size')
        ...
        g1234.savefig(fname= output_folder 
                        + '/masked/phase1_plot/combined_genome_length_w_std.tif',
                    format= 'tif'
                        )
